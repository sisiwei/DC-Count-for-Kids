...
// 		var a = "javascript:(function(){window.twttr=window.twttr||{};var D=550,A=450,C=screen.height,B=screen.width,H=Math.round((B/2)-(D/2)),G=0,F=document,E;if(C>A){G=Math.round((C/2)-(A/2))}window.twttr.shareWin=window.open('http://twitter.com/intent/tweet/?url=http://www.dcactionforchildren.org/kids-count/dc-kids-count-data-tools&text=See%20how%20the%20well-being%20of%20children%20and%20families%20in%20DC%20compares%2C%20neighborhood%20by%20neighborhood.&via=ActforDChildren','','left='+H+',top='+G+',width='+D+',height='+A+',
